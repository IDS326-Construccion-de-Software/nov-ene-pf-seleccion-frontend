...
import { AppLayout2LayoutConfig } from './';

// Interface defining the properties of the layout provider context
export interface IAppLayout2LayoutProviderProps {
...
// Initial layout provider properties
const initalLayoutProps: IAppLayout2LayoutProviderProps = {
  layout: AppLayout2LayoutConfig, // Default layout configuration
...
// Create a context to manage the layout-related state and logic
const AppLayout2LayoutContext = createContext<IAppLayout2LayoutProviderProps>(initalLayoutProps);

// Custom hook to access the layout context in other components
const useAppLayout2Layout = () => useContext(AppLayout2LayoutContext);

// Provider component that sets up the layout state and context
const AppLayout2LayoutProvider = ({ children }: PropsWithChildren) => {
  ...
  const layoutConfig = deepMerge(AppLayout2LayoutConfig, getLayout(AppLayout2LayoutConfig.name));
  ...
  return (
    <AppLayout2LayoutContext.Provider
      value={{
...
export { AppLayout2LayoutProvider, useAppLayout2Layout };
