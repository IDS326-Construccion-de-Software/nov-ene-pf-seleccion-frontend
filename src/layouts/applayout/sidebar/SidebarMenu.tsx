      ...
      return (
        ...
        >
          ...
          >
            <MenuIcon
              className={clsx(
                'items-start text-gray-500 dark:text-gray-400 menu-link-hover:!text-primary',
                iconWidth
              )}
            >
              {item.icon && <KeenIcon icon={item.icon} className={iconSize} />}
            </MenuIcon>
            <MenuTitle className="text-sm font-medium text-gray-800 menu-item-active:text-primary menu-link-hover:!text-primary menu-link-hover:!font-semibold">
              {item.title}
            </MenuTitle>
            {buildMenuArrow()}
          </MenuLink>
      ...
      return (
        <MenuItem key={index}>
          <MenuLink
            path={item.path}
            className={clsx(
              'border border-transparent menu-item-active:bg-secondary-active dark:menu-item-active:bg-coal-300 dark:menu-item-active:border-gray-100 menu-item-active:rounded-lg',
              accordionLinkGap[0],
              linkPy,
              linkPl,
              linkPr
        ...
        >
          ...
          >
            ...
            {item.collapse ? (
              ...
              <MenuTitle className="text-2sm font-normal me-1 text-gray-800 menu-item-active:text-primary menu-item-active:font-medium menu-link-hover:!text-primary menu-link-hover:!font-semibold">
                {item.title}
              </MenuTitle>
            )}
      ...
      return (
        <MenuItem key={index}>
          <MenuLink
            path={item.path}
            className={clsx(
              'border border-transparent items-center grow menu-item-active:bg-secondary-active dark:menu-item-active:bg-coal-300 dark:menu-item-active:border-gray-100 menu-item-active:rounded-lg',
              accordionLinkGap[level],
              accordionLinkPl,
              linkPr,
              subLinkPy
          ...
          >
            {/* {buildMenuBullet()} */}
            <MenuTitle className="text-2sm font-normal text-gray-800 menu-item-active:text-primary menu-item-active:font-semibold menu-link-hover:!text-primary menu-link-hover:!font-semibold">
              {item.title}
            </MenuTitle>
          </MenuLink>
        </MenuItem>
  ...
  const buildMenuArrow = () => {
    return (
      <MenuArrow className={clsx('text-gray-400 w-[20px] shrink-0 justify-end ms-1', rightOffset)}>
        <KeenIcon icon="down" className="text-2xs menu-item-show:hidden" />
        <KeenIcon icon="up" className="text-2xs hidden menu-item-show:inline-flex" />
      </MenuArrow>
    );
  };
