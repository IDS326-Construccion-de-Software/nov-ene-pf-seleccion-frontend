...
const Highlights = ({ limit }: IHighlightsProps) => {
  ...
  const items: IHighlightsItems = [
    { badgeColor: 'badge-danger', lebel: 'Completadas' },
    { badgeColor: 'badge-gray-800', lebel: 'Pendientes' },
    { badgeColor: 'badge-info', lebel: 'Convalidadas' }
  ];
  ...
  return (
    <div className="card h-full">
      <div className="card-header">
        <h3 className="card-title">Asignaturas cursadas</h3>
      ...
      <div className="card-body flex flex-col gap-4 p-5 lg:p-7.5 lg:pt-4">
        <div className="flex flex-col gap-0.5">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-3xl font-normal text-gray-900">|</span>
            <span className="text-3xl font-semibold text-gray-900">70</span>
            <span className="badge badge-outline badge-success badge-sm">+2.7%</span>
          </div>
        </div>

        <div className="flex items-center gap-1 mb-1.5">
          <div className="bg-primary h-2 w-full max-w-[60%] rounded-sm"></div>
          <div className="bg-gray-400 h-2 w-full max-w-[25%] rounded-sm"></div>
          <div className="bg-gray-400 h-2 w-full max-w-[15%] rounded-sm"></div>
        </div>
        ...
        <span className="text-sm font-normal text-gray-700">Trimestre</span>
        <span className="text-sm font-bold text-gray-700">Noviembre 2025 - Enero 2026 </span>
