...
interface AcademicSchedulePreselectionProps {
  oferta: AsignaturaOferta[];
}

const AcademicSchedulePreselection = ({ oferta }: AcademicSchedulePreselectionProps) => {
                ...
                <TableRow>
                  <TableCell colSpan={10} className="text-center py-10 text-gray-500">
                    <div className="flex flex-col items-center justify-center gap-2">
                      ...
                      <span>No has preseleccionado ninguna asignatura todavía.</span>
                    </div>
                  </TableCell>
                </TableRow>
              ) : (
...
export { AcademicSchedulePreselection };
