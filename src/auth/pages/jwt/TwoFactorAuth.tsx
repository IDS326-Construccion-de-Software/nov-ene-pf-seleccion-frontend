    ...
    <div className="card max-w-[380px] w-full">
      <form className="card-body flex flex-col gap-5 p-10">
        ...
        <div className="text-center mb-2">
          <h3 className="text-lg font-medium text-gray-900 mb-5">Verifica tu teléfono</h3>
        ...
        <div className="flex items-center justify-center mb-2">
          <span className="text-xs text-gray-700 me-1.5">¿No recibiste el código? (37s)</span>
          <Link to="/auth/classic/login" className="text-xs link">
            Reenviar
          </Link>
        </div>

        <button className="btn btn-primary flex justify-center grow">Continuar</button>
