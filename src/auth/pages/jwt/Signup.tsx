...
const Signup = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { setStatus, setSubmitting }) => {
      ...
      try {
        ...
        console.error(error);
        setStatus('Los datos de registro son incorrectos');
        setSubmitting(false);
        setLoading(false);
      }
    }
  ...
  return (
    <div className="card max-w-[370px] w-full">
      ...
      >
        <h3 className="text-lg font-semibold text-gray-900 text-center leading-none mb-2.5">
          Registrarse
        </h3>
        ...
        <div className="flex flex-col gap-1">
          ...
          <label className="input">
            <input
              ...
              placeholder="Volver a escribir contraseña"
              autoComplete="off"
        ...
        <label className="checkbox-group">
          ...
          <span className="checkbox-label">
            Acepto los{' '}
            <Link to="#" className="text-2sm link font-semibold text-foreground hover:text-primary">
        ...
        <div className="flex items-center justify-center font-medium">
          <span className="text-2sm text-gray-600 me-1.5">¿Ya tienes una cuenta?</span>
          <Link
