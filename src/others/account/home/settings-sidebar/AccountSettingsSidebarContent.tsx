...
import { AccountSettingsSidebar } from '@/others/account/home/settings-sidebar';
import { useLayout } from '@/providers';

const stickySidebarClasses: Record<string, string> = {
  'applayout-layout': 'top-[calc(var(--tw-header-height)+1rem)]',
  'applayout3-layout': 'top-[calc(var(--tw-header-height)+var(--tw-navbar-height)+1rem)]',
  'applayout4-layout': 'top-[3rem]',
